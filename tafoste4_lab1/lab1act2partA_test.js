...
console.log(c.calc('{"op": "add", "number": 0}')); // expected: 0
console.log(c.calc('{"op": "add", "number": -1}')); // expected: -1
console.log(c.calc('{"op": "subtract", "number": -1}')); // expected: 0
console.log(c.calc('{"op": "add", "number": 5}')); // expected: 5
console.log(c.calc('{"op": "subtract", "number": 10}')); // expected: -5
console.log(c.calc('{"op": "add", "number": 15}')); // expected: 10
